...
- Haplotypes in *ROHs* can underlie identity either by **state** (IBS) or by **descent** (IBD). IBD occurs when two haplotypes originate from a common ancestor, a condition whcih we refer to as **autozygosity**
...
- Computational approaches have been developed to identify *ROHs* in targeted sequencing data from **hybrid capture** experiments
